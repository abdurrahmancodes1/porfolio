    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            Looking for opportunities to grow as a developer. Let’s connect and
            collaborate.
          </motion.p>
        </motion.div>
                ...
                {CONTACT_INFO.map((info, index) => {
                  return (
                    <motion.div
                      ...
                      variants={itemVariants}
                      whileHover={{ x: 4 }}
                      className={`flex items-center space-x-4 items-center rounded-xl ${
                        isDarkMode
              ...
              <div className="">
                {SOCIAL_LINKS.map((socail) => {
                  return (
                    ...
                    >
                      <socail.icon size={20} />
                      <span className="">{socail.name}</span>
                    </motion.a>
                  );
                })}
              </div>
        ...
        >
          ...
          >
            ...
            >
              <PopupButton
                url="https://calendly.com/abdurrahman-codes1/30min"
