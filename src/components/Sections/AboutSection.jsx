...
// Public signature image served from `public/assets`
const SIGNATURE = "/assets/signAbdur.png";
import { JOURNEY_STEPS, PASSIONS } from "../../../utils/data";
import { FaChalkboardTeacher } from "react-icons/fa"; // Example teaching icon
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              ...
              >
                When I'm not coding, I’ve been teaching Physics, Chemistry, and
                Math since 2019, helping students grow while balancing my tech
                projects.
              </p>
            </motion.div>
              ...
              <div className="grid gap-2">
                {PASSIONS.map((passion) => (
                  <motion.div
                    ...
                    variants={item}
                    whileHover={{ x: 4 }}
                    className={`flex items-center space-x-4 rounded-xl p-4 ${
                      isDarkMode
          ...
          >
              ...
              <div className="relative">
                ...
                {JOURNEY_STEPS.map((step) => (
                  <motion.div
                    ...
                    whileHover={{ x: 4 }}
                    className="relative flex items-center space-x-6 group mb-8"
                  >
                    <div
                    ...
                    >
                      ...
                      <div
                        className={`text-sm font-medium ${
                          isDarkMode ? "text-blue" : "text-blue-600"
                        } mb-3`}
                      >
                        {step.school}
                      </div>
            ...
            <motion.div initial="hidden" animate={timelineVariants}>
              <h3 className="text-2xl font-medium mb-8 text-center lg:text-left">
                Experience
              </h3>
              <div className="relative">
                ...
                >
                  <div className="relative z-10 flex-shrink-0 w-16 h-16 rounded-full bg-green-500 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  ...
                  >
                    ...
                    >
                      Mentoring students in Physics, Chemistry, and Math while
                      balancing tech projects.
                    </p>
                  </div>
                </motion.div>
              </div>
        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-blue-500 hover:bg-blue-600 text-white py-3 px-8 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300"
            >
              Let's Work Together
            </motion.button>
          </motion.div>
