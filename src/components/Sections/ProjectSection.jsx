...
const ProjectSection = () => {
  ...
  return (
    ...
    >
      ...
      blur-3xl opacity-5 ${isDarkMode ? "bg-blue-500" : "bg-blue-400"}`}
        />
        <div
          className={`absolute bottom-20 right-1/4 w-80 h-80 rounded-full
      blur-3xl opacity-5 ${isDarkMode ? "bg-purple-500" : "bg-purple-400"}`}
        />
      </div>
      <div className="max-w-7xl  mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            modern web applicaions and solving complex problems.
          </motion.p>
        </motion.div>
        {/* Projects Grid  */}
        <motion.div
